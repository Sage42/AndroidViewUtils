...
public class MyChronometer extends Chronometer
{
    ...
    public MyChronometer(final Context context, final AttributeSet attrs, final int defStyle)
    {
        super(context, attrs, defStyle);
        this.initCustomFonts(context, attrs);
    }

    public MyChronometer(final Context context, final AttributeSet attrs)
    {
        super(context, attrs);
        this.initCustomFonts(context, attrs);
    }

    public MyChronometer(final Context context)
    {
        super(context);
