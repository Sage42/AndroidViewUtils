...
public class MyRadioButton extends RadioButton
{
    ...
    public MyRadioButton(final Context context, final AttributeSet attrs, final int defStyle)
    {
        super(context, attrs, defStyle);
        this.initCustomFonts(context, attrs, defStyle);
    }

    public MyRadioButton(final Context context, final AttributeSet attrs)
    {
        super(context, attrs);
        this.initCustomFonts(context, attrs, -1);
    }

    public MyRadioButton(final Context context)
    {
        super(context);
