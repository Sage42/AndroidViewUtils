 ...
 *
 */
public class MyExtractEditText extends ExtractEditText
{

    public MyExtractEditText(final Context context, final AttributeSet attrs, final int defStyle)
    {
        super(context, attrs, defStyle);
        this.initCustomFonts(context, attrs, defStyle);
    }

    public MyExtractEditText(final Context context, final AttributeSet attrs)
    {
        super(context, attrs);
        this.initCustomFonts(context, attrs, -1);
    }

    public MyExtractEditText(final Context context)
    {
        super(context);
